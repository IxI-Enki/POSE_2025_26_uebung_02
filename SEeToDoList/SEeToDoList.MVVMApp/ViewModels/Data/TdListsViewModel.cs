...
namespace SEeToDoList.MVVMApp.ViewModels.Data
{
    ...
    /// </summary>
    public partial class TdListsViewModel : GenericItemsViewModel<Models.Data.TdList>
    {
        /// <summary>
        /// Initializes the class (created by the generator).
        /// </summary>
        static TdListsViewModel()
        {
            ClassConstructing();
            ClassConstructed();
        }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TdListsViewModel"/> class (created by the generator.)
        /// </summary>
        public TdListsViewModel()
        {
            Constructing();
