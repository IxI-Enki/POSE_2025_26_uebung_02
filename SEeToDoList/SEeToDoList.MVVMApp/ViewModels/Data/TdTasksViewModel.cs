...
namespace SEeToDoList.MVVMApp.ViewModels.Data
{
    ...
    /// </summary>
    public partial class TdTasksViewModel : GenericItemsViewModel<Models.Data.TdTask>
    {
        /// <summary>
        /// Initializes the class (created by the generator).
        /// </summary>
        static TdTasksViewModel()
        {
            ClassConstructing();
            ClassConstructed();
        }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TdTasksViewModel"/> class (created by the generator.)
        /// </summary>
        public TdTasksViewModel()
        {
            Constructing();
