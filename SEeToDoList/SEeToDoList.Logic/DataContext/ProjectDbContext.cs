//@CodeCopy
using SEeToDoList.Common.Modules.Exceptions;
...
{
    /// <summary>
    /// Represents the database context for the SEeToDoList application.
    /// </summary>
    internal sealed partial class ProjectDbContext : DbContext, IContext
    {
        ...
        /// </summary>
        private static readonly string ConnectionString = "data source=SEeToDoList.db";
        #endregion fields
        ...
        #region events
        /// <summary>
        /// Occurs before the context saves changes to the database.
        /// Subscribers can use this event to perform custom logic or validation before changes are persisted.
        /// </summary>
        internal event EventHandler<EntriesSaveChangesEventArgs>? BeforeSaveChangesEvent;
        /// <summary>
        /// Occurs after the context has saved changes to the database.
        /// Subscribers can use this event to perform custom logic or actions after changes are persisted.
        /// </summary>
        internal event EventHandler<EntriesSavedChangesEventArgs>? AfterSavedChangesEvent;
        #endregion events
