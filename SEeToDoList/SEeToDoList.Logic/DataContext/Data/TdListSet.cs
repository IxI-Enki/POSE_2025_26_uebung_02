...
*****************************************************************************************/
namespace SEeToDoList.Logic.DataContext.Data
{
    using TEntity = Entities.Data.TdList;
    using TContract = SEeToDoList.Common.Contracts.Data.ITdList;
    /// <summary>
    /// Generated by the generator.
    /// </summary>
    internal sealed partial class TdListSet : EntitySet<TEntity>, Contracts.Data.ITdListSet
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TdListSet"/> class (created by the generator.)
        /// </summary>
        public TdListSet(ProjectDbContext context, DbSet<TEntity> dbSet)
         : base(context, dbSet)
        {
            Constructing();
