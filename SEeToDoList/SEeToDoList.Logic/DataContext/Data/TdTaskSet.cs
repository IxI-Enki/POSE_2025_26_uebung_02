...
{
    using TEntity = Entities.Data.TdTask;
    using TContract = SEeToDoList.Common.Contracts.Data.ITdTask;
    /// <summary>
    /// Generated by the generator.
    /// </summary>
    internal sealed partial class TdTaskSet : EntitySet<TEntity>, Contracts.Data.ITdTaskSet
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TdTaskSet"/> class (created by the generator.)
        /// </summary>
        public TdTaskSet(ProjectDbContext context, DbSet<TEntity> dbSet)
         : base(context, dbSet)
        {
            Constructing();
