//@CodeCopy
#if ACCOUNT_ON
using SEeToDoList.Logic.Entities.Account;
using SEeToDoList.Logic.Modules.Exceptions;
using SEeToDoList.Logic.Modules.Security;
using System.Text;

namespace SEeToDoList.Logic.Modules.Account
{
    using PasswordRules = CommonModules.Security.PasswordRules;
    using Error = CommonModules.Exceptions.ErrorType;
    using System.Reflection;
    using SEeToDoList.Common.Modules.ThreadSafe;
