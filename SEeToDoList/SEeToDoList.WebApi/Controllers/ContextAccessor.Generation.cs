...
namespace SEeToDoList.WebApi.Controllers
{
    ...
    partial class ContextAccessor
    {
        ...
        {
            if (typeof(TEntity) == typeof(SEeToDoList.Logic.Entities.Data.TdList))
            {
                entitySet = GetContext().TdListSet as Logic.Contracts.IEntitySet<TEntity>;
                handled = entitySet != default;
            }
            if (typeof(TEntity) == typeof(SEeToDoList.Logic.Entities.Data.TdTask))
            {
                entitySet = GetContext().TdTaskSet as Logic.Contracts.IEntitySet<TEntity>;
                handled = entitySet != default;
            }
        }
        /// <summary>
