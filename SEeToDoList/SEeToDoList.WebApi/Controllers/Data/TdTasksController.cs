...
{
    using TModel = SEeToDoList.WebApi.Models.Data.TdTask;
    using TEntity = SEeToDoList.Logic.Entities.Data.TdTask;
    using TContract = SEeToDoList.Common.Contracts.Data.ITdTask;
    /// <summary>
    /// Generated by the generator.
    /// </summary>
    public sealed partial class TdTasksController(Contracts.IContextAccessor contextAccessor) : Controllers.GenericEntityController<TModel, TEntity, TContract>(contextAccessor)
    {
        /// <summary>
        /// Initializes the class (created by the generator).
        /// </summary>
        static TdTasksController()
        {
            ClassConstructing();
            ClassConstructed();
        }
